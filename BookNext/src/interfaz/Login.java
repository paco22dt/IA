...
public class Login extends JPanel {
	...
	private JTextField txtContraseña_nueva;
	...
	public Login() {
		...
		txtContraseña_nueva = new JTextField();
		panel.add(txtContraseña_nueva);
		txtContraseña_nueva.setColumns(10);
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if(!user.equals("") && !pass.equals(""))
				{
					try
					{
						...
						if(id != 0)
						{
							InterfaceBook ib= new InterfaceBook(id);
							ib.setVisible(true);
						}
						else
						{
